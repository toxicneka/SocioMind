...
text_start = """
👋 Я - SocioMind AI Agent, бот для анализа командной совместимости на основе соционики!
...
• Добавить меня в групповой чат
• Дать права администратора
• Чтобы >70% участников прошли тест

▶️ <b>Доступные команды:</b>
/test - пройти тестирование личности
/report - получить анализ группы
"""
